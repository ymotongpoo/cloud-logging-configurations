...
class GCLJsonFormatter extends JsonFormatter
{
    public function format(array $record) : string
    {
        ...
        $log = $this->toJson($this->normalize($record), true) . ($this->appendNewline ? "\n" : '');
        return $log;
    }
}

$logger = new Logger('monolog-json-sample');

$formatter = new GCLJsonFormatter();
